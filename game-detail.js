document.addEventListener("DOMContentLoaded", () => {
  ...
  const gameImages = {
    ...
    "Piano Tiles 2 Unblocked": "../images/piano-tiles-2.png", // Changed from Hole.io Unblocked
  }
  ...
  const gameURLs = {
    ...
    "Piano Tiles 2 Unblocked": "https://h5.4j.com/games/Piano-Tiles-2-Online/index.html", // Changed from Hole.io Unblocked
  }
  ...
  if (gameTitle) {
    ...
    document.title = `Play ${gameName} - Piano Tiles 2` // Updated branding
  }
  ...
  function createHotGameCard(game) {
    ...
    if (game === "Piano Tiles 2 Unblocked") {
