document.addEventListener("DOMContentLoaded", () => {
  ...
  const gameCategories = {
    ...
    arcade: [
      ...
      "Piano Tiles 2 Unblocked", // Changed from Hole.io Unblocked
    ],
    casual: [
      "Tag Unblocked",
      "Among Us Unblocked",
  ...
  const gameDetails = {
    ...
    "Piano Tiles 2 Unblocked": {
      // Changed from Hole.io Unblocked
      image: "images/piano-tiles-2.png", // New image
      url: "https://h5.4j.com/games/Piano-Tiles-2-Online/index.html", // Example URL for Piano Tiles 2
      description: "Tap the black tiles and avoid the white ones in this addictive rhythm game.",
      genre: "RhythmGame",
      keywords: "piano tiles 2, unblocked, rhythm, music, tap, arcade",
    },
  }
  ...
  if (playNowBtn) {
    playNowBtn.addEventListener("click", () => {
      ...
      const mainGameUrl = gameDetails["Piano Tiles 2 Unblocked"].url || "https://play.wgplayground.com/ifr/placeholder"
  ...
  function createHotGameCard(gameName) {
    ...
    // Redirect Piano Tiles 2 Unblocked to the homepage
    if (gameName === "Piano Tiles 2 Unblocked") {
      gameUrl = "index.html"
    }
